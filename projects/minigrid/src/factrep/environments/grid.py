...
from projects.minigrid.src.factrep.environments.world_object import Wall, WorldObj
...
class Grid:
    ...
    def render_tile(
        ...
        if agent_dir is not None:
            tri_fn = point_in_circle(0.52, 0.52, 0.25)

            # Rotate the agent based on its direction
            tri_fn = rotate_fn(tri_fn, cx=0.5, cy=0.5, theta=0.5 * math.pi * agent_dir)
            fill_coords(img, tri_fn, (249, 168, 212))
